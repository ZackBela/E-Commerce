          ...
          children: [
            ...
            Row(
              children: [
                ...
                .decorated(
                  color: kcTextColor.withOpacity(.02),
                ...
                ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ProductWidget(
                      ...
                      onAddTap: () async {
                        await viewModel.addProductTocart(productsList[index]);
                      },
                      onFavTap: () async {
                        viewModel.favProductsIds
                                .contains(productsList[index]["id"])
                            ? await viewModel.deleteFromFavProducts(
                                productsList[index]["id"])
                            : await viewModel
                                .addToFavProducts(productsList[index]);
                      },
            ...
            ).scrollable(physics: BouncingScrollPhysics()).expanded(),
          ],
        ).height(screenHeight(context)).safeArea().padding(
