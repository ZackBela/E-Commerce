...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<LocalDbServicesService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
void registerServices() {
  ...
  getAndRegisterLocalDbServicesService();
...
MockLocalDbServicesService getAndRegisterLocalDbServicesService() {
  _removeRegistrationIfExists<LocalDbServicesService>();
  final service = MockLocalDbServicesService();
  locator.registerSingleton<LocalDbServicesService>(service);
  return service;
}
// @stacked-mock-create
